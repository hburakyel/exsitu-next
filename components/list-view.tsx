    ...
    <div className="container mx-auto p-4 space-y-4">
      ...
      <div className="space-y-4">
        {objects.map((object, index) => (
          <div
            key={object.id}
            className="flex flex-col md:flex-row gap-4 p-4 border border-gray-200 dark:border-gray-800 rounded-lg hover:ring-2 hover:ring-blue-500 cursor-pointer transition-all"
          ...
          >
            <div className="w-full md:w-48 h-48 relative flex-shrink-0">
              ...
              >
                <span className="text-muted-foreground text-sm">{object.attributes.inventory_number || "No ID"}</span>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs ">
                <div>
                  ...
                  <span className="">{object.attributes.place_name || "Unknown"}</span>
                </div>

                <div>
                  <span className="text-muted-foreground ">To: </span>
                  <span className="">{object.attributes.institution_name || "Unknown"}</span>
                </div>

                <div>
                  <span className="text-muted-foreground ">Institution: </span>
                  <span className="">{object.attributes.institution_place || "Unknown"}</span>
                </div>

                <div>
                  <span className="text-muted-foreground ">ID: </span>
                  <span className="">{object.attributes.inventory_number || "Unknown"}</span>
                </div>
              </div>
