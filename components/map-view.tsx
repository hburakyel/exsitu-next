...
import { AlertTriangle, RefreshCcw, Search, X, ChevronDown, ChevronUp } from "lucide-react"
    ...
    return (
      <div className="relative w-full h-full">
        ...
        {showSearchBoxInternal && (
          <div
            className={`absolute top-16 left-4 right-4 sm:right-auto sm:w-80 z-50 transition-all duration-300 ${
              showSearchBoxInternal ? "opacity-100" : "opacity-0 pointer-events-none"
            }`}
          >
            <div className="bg-white p-4 rounded-lg shadow-lg">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-sm font-medium"></h3>
                {/* Update the search box close button: */}
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-6 w-6"
              ...
              <SearchBox onLocationFound={onLocationFound} onClose={() => setShowSearchBoxInternal(false)} />
